...
def load_data():
    ...
    df_main = pd.read_excel(os.path.join(base_path, "db.xlsx"), engine="xlrd")
    df_filtered = pd.read_excel(os.path.join(base_path, "filtered_goals_all_matches.xlsx"), engine="xlrd")
